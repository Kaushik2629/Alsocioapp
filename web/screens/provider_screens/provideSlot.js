...
import { View, Text, Button, StyleSheet, StatusBar, Modal,TouchableOpacity,
...
const providerSlot = ({ navigation }) => {
	...
	// 	customer_name.append('username', a);
				...
				<View
					...
					<View
						...
						<TouchableOpacity
							...
							onPress={() => 
								{deleteBooking(bookingId,name),setShowPickerModal(!showPickerModal)}
							}>
							<Text
								style={{
									alignSelf: 'center',
						...
						<TouchableOpacity
							...
							<Text
								...
								onPress={() => {
									setConfirm(false), setShowPickerModal(!showPickerModal);
								}}>
								No
							</Text>
						</TouchableOpacity>
					...
					<View style={{ flexDirection: 'row' }}>
						...
						<Picker
							...
							onValueChange={(itemValue) => {
								...
								let bookingdetails = new FormData();
								bookingdetails.append('booking_id', bookingId);
								bookingdetails.append('username', name);
								bookingdetails.append('service_date', date);
								bookingdetails.append('service_time', itemValue);
								fetch(
									'https://alsocio.geop.tech/app/update-service-date-time/',
									{
										method: 'POST',
										body: bookingdetails,
									}
